...
<div class="flex justify-center mt-4">
    <button onclick="window.location='{{ route('api.create') }}'"
        class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">
        Crear Un Nuevo Punto
    </button>
</div>
<div class="mt-10">
    <h2 class="text-2xl font-semibold text-center">Ubicaciones Maps APis</h2>
